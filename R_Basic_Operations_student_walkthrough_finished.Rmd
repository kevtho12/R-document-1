...
```{r}
substr('how much wood could woodchuck chuck', start <-5, stop <-13)
```
...
```{r}
sub('much', 'little','how much wood could a woodchuck wood')
```
...
Return True/False, contains expression such as + - \* / = \< \> != \<= \>=.
